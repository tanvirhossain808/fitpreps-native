...
import ShappedAll from 'public/images/shop/shapped/all.svg';
import ShappedLeggins from 'public/images/shop/shapped/leggins.svg';
import ShappedShorts from 'public/images/shop/shapped/shorts.svg';
import ShappedSportsBras from 'public/images/shop/shapped/sport-bras.svg';
import ShappedTops from 'public/images/shop/shapped/tops.svg';
...
export const shapedSelecteCategories = [
  {
    name: 'All',
    img: '',
    svg: () => createElement(ShappedAll),
    id: 1,
  },
  {
    name: 'Leggings',
    img: '',
    svg: () => createElement(ShappedLeggins),
    id: 8,
  },
  {
    img: '',
  ...
  },
  {
    img: '',
    name: 'Sports Bras ',
    svg: () => createElement(ShappedSportsBras),
    id: 3,
  },
  {
    img: '',
    name: 'Tops',
    svg: () => createElement(ShappedTops),
    id: 4,
  },
  {
    img: '',
